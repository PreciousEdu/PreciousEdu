...
Performed customer segmentation analysis to identify high-value customers and purchasing trends.

### SQL Business Analysis
Used SQL queries to analyze transactional datasets and extract business insights.

### Marketing Campaign Analysis
Evaluated campaign performance metrics and engagement trends.
